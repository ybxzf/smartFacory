    ...
    <el-row class="base-info row1">
      <el-col :span="4" class="base-info-col col1">
        <div class="base-item">
          ...
          <el-tooltip effect="dark" v-if="baseInfo.workOrder && baseInfo.workOrder.length > 13"
            :content="baseInfo.workOrder" placement="top">
            <div class="item-value">
              {{ baseInfo.workOrder.slice(0, 13) + '...' || '-' }}
            </div>
          </el-tooltip>
      ...
      <el-col :span="4" class="base-info-col">
        <div class="base-item">
          ...
          <el-tooltip effect="dark" v-if="baseInfo.customer && baseInfo.customer.length > 13"
            :content="baseInfo.customer" placement="top">
            <div class="item-value">
              {{ baseInfo.customer.slice(0, 13) + '...' || '-' }}
            </div>
          </el-tooltip>
          <div class="item-value" v-else>
            {{ baseInfo.customer || '-' }}
      ...
      <el-col :span="4" class="base-info-col">
        <div class="base-item">
          ...
          <el-tooltip effect="dark" v-if="baseInfo.productName && baseInfo.productName.length > 13"
            :content="baseInfo.productName" placement="top">
            <div class="item-value">
              {{ baseInfo.productName.slice(0, 13) + '...' || '-' }}
            </div>
          </el-tooltip>
          <div class="item-value" v-else>
      ...
      <el-col :span="4" class="base-info-col">
        <div class="base-item">
          ...
          <el-tooltip effect="dark" v-if="baseInfo.productModel && baseInfo.productModel.length > 13"
            :content="baseInfo.productModel" placement="top">
            <div class="item-value">
              {{ baseInfo.productModel.slice(0, 13) + '...' || '-' }}
            </div>
          </el-tooltip>
          <div class="item-value" v-else>
      ...
      <el-col :span="8" class="base-info-col col2">
        <div class="base-item">
          ...
          <div class="item-chart">
            ...
            <pieChart3D v-if="fctDefectStatsList.length" height="100%" :chartData="fctDefectStatsList"></pieChart3D>
          </div>
        </div>
      </el-col>
    </el-row>
