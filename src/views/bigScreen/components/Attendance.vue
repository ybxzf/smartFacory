	...
	<div class="section">
		<div class="attendance common-section">
			...
			<div class="top-content">
				<div class="top">
					<span>预计出勤: {{ this.attendance.expectedQuantity || '-' }}</span>
					<span>实际出勤: {{ this.attendance.actualQuantity || '-' }}</span>
				</div>
			</div>
			...
			<div class="bottom-content">
				<div class="common-part">
					...
					<div class="data-content">
						<span class="num">{{ this.attendance.expectedQuantity || '-' }}</span>
				...
				<div class="common-part">
					...
					<div class="data-content">
						<span class="num">{{ this.attendance.actualQuantity || '-' }}</span>
				...
				<div class="common-part">
					...
					<div class="data-content">
						<span class="num">{{ this.attendance.expectedQuantity | getRate(this.attendance.actualQuantity) }}</span>
		...
		<div class="attendance common-section">
			...
			<div class="top-content">
				<div class="top">
					<span>当日计划产能: {{ this.capacity.plannedQuantity || '-' }}</span>
					<span>当日完成产能: {{ this.capacity.currentQuantity || '-' }}</span>
				</div>
			</div>
...
export default {
	...
	filters: {
		getRate(expectedQuantity, actualQuantity) {
			if (!expectedQuantity || !actualQuantity) {
				return '-';
			} else {
				return (((actualQuantity / expectedQuantity).toFixed(2)) * 100) + '%';
			}
		},
	},
	data() {
	...
	watch: {
		capacity: {
			handler: function (newValue) {
				// this.optionsData = this.optionsData.map(item => {
