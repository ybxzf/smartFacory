  ...
  <div style="height: 100%" class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        prop="actualQuantity"
      />
      <el-table-column label="检测类型" align="center" prop="actualQuantity" />
      <el-table-column label="检测机构" align="center" prop="actualQuantity" />
      <el-table-column
        label="报告出具单位"
        align="center"
        prop="actualQuantity"
      />
      <el-table-column label="报告出具日期" align="center" prop="id">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.date, "{y}-{m}-{d}") }}</span>
        </template> </el-table-column
      ><el-table-column label="报告有效截止日期" align="center" prop="id">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.date, "{y}-{m}-{d}") }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog center :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="160px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="产品详细信息编号" prop="actualQuantity">
              <el-input
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="检测报告编号" prop="actualQuantity">
              <el-input
                v-model="form.actualQuantity"
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="检测类型" prop="actualQuantity">
              <el-input
                v-model="form.actualQuantity"
                placeholder="请输入检测类型"
              />
          ...
          <el-col :span="12">
            <el-form-item label="检测机构" prop="actualQuantity">
              <el-input
                v-model="form.actualQuantity"
                placeholder="请输入检测机构"
              />
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="报告出具单位" prop="expectedQuantity">
              <el-input
                v-model="form.expectedQuantity"
          ...
          <el-col :span="12">
            <el-form-item label="报告出具日期" prop="actualQuantity">
              <el-date-picker
                clearable
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="报告有效截止日期" prop="actualQuantity">
              <el-date-picker
                clearable
                v-model="queryParams.date"
                type="date"
          ...
          <el-col :span="12">
            <el-form-item label="见证材料附件" prop="actualQuantity">
              <el-upload
                action="#"
